...
#ifndef __AP_HAL_TiCopter_I2CDRIVER_H__
#define __AP_HAL_TiCopter_I2CDRIVER_H__

#include "AP_HAL_TiCopter.h"

class TiCopter::TiCopterI2CDriver : public AP_HAL::I2CDriver {
public:
    TiCopterI2CDriver(AP_HAL::Semaphore* semaphore) : _semaphore(semaphore) {}
    void begin();
    void end();
...
#endif // __AP_HAL_TiCopter_I2CDRIVER_H__
